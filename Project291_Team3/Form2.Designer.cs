namespace Project291_Team3
{
    partial class Form2
    {
        ...
        private void InitializeComponent()
        {
            ...
            // createNewCustomer
            // 
            createNewCustomer.Location = new Point(234, 345);
            ...
            // customerPhoneInput
            // 
            customerPhoneInput.Location = new Point(234, 168);
            customerPhoneInput.Name = "customerPhoneInput";
            customerPhoneInput.Size = new Size(320, 35);
            customerPhoneInput.TabIndex = 1;
            customerPhoneInput.Text = "Enter Customer Phone";
            customerPhoneInput.TextChanged += textBox1_TextChanged;
            // 
            // customerSearchButton
            // 
            customerSearchButton.Location = new Point(560, 168);
